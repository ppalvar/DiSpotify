<template>
  <div class="player-controls">
    <div class="control-buttons mb-3">
      <button><i class="fas fa-random" @click="shuffleList"></i></button>
      <button @click="prevSong"><i class="fas fa-step-backward"></i></button>
      ...
      <button @click="setAndUnsetRepeat"><i class="fas fa-redo" :class="{ selected: repeat }"></i></button>
    </div>

    <div
      class="progress-bar-container d-flex align-items-center container-fluid"
    >
...
export default {
  ...
  methods: {
    ...mapActions(["playAndPause", "setVolume", "moveToTime", "nextSong", "prevSong", "shuffleList", "setAndUnsetRepeat"]),
  },
};
</script>
...
.control-buttons {
  ...
  margin-bottom: 1rem; /* Mantiene el margen inferior existente */
}
